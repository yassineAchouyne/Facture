                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('societe') is-invalid @enderror" name="societe" value="{{ old('societe') }}" required >
                                    <option value="0">Auto Entrepreneur</option>
                                    <option value="1">Socéitée</option>
                                </select>
                                @error('name')
